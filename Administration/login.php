						...
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="http://phpoll.com/login/process" method="post" role="form" style="display: block;">
									...
									<div class="form-group">
										<div class="row">
											<label class="radio-inline"><input type="radio" name="statut" checked="true">Étudiant</label>
											<label class="radio-inline"><input type="radio" name="statut">Enseignant</label>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
