...
(5, 'toto', 'asdg', 'asdf', 'asdf', 'asdf', 'asf', 'asdf', './Plaquettes/Notions_de_base.pdf', './Images/Mascottes/caisseNormal.png', './Images/backgroundParcours/caisseDiffuse.png');
...
--
ALTER TABLE `actualites`
  MODIFY `ID_actualites` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `data`
  MODIFY `ID_data` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
--
...
--
ALTER TABLE `elevestoprojet`
  MODIFY `ID_elevestoprojet` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
--
...
--
ALTER TABLE `matierestoprojet`
  MODIFY `ID_matierestoprojet` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
...
--
ALTER TABLE `projets`
  MODIFY `ID_projets` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
